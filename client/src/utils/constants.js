...
export const WIZARD = Object.freeze({
  ...
  audio: Object.freeze({
    ...
    orbReplace: 'Re-recording take {number}',
    ...
    uploading: 'Uploading…',
    progressHint: Object.freeze({
      empty: 'Your story takes shape here — record or attach your first take.',
      few: 'Good start — add more to cover the whole day.',
      many: 'The story covers the day — ready when you are.',
    }),
    peekTitle: 'Your raw report so far',
    peekToggle: 'Show raw report',
    narrationOne: 'Merged narration of 1 take',
    narrationMany: 'Merged narration of {count} takes',
  }),
});